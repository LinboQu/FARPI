...
def main():
    ...
    parser = argparse.ArgumentParser(description="Noise-level controlled Isotropic noise ablation on Stanford_VI seismic cube.")
    ...
    parser.add_argument("--runs-root", type=str, default=join("runs", "noise_ablation_isotropic"))
    ...
    parser.add_argument("--snr-power", type=float, default=0.5)
    ...
    base_train.update(
        {
            ...
            "eta_floor_ratio": float(alpha_floor_ratio),
