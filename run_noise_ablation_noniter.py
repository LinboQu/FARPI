...
def main():
    ...
    parser = argparse.ArgumentParser(description="Noise-level controlled Non-iterative noise ablation on Stanford_VI seismic cube.")
    ...
    parser.add_argument("--runs-root", type=str, default=join("runs", "noise_ablation_noniter"))
